...
<body>
    ...
    <div class="rectangle">
        <div class="left-section">
            <p class="info" style="text-shadow: 4px 3px 0px rgba(171, 183, 183, 1), 9px 8px 0px rgba(0,0,0,0.15); font-size: xxx-large"> GALERIAS </p>
            <a href="../php/Sección_Explorar.php" class="btn btn-outline-dark" style="margin-top: 5px; font-size: 24px; background: #9ab7b7"> Fotos</a>
            <a href="../php/Filtros_Galerias.php" class="btn btn-outline-dark" style="margin-top: 5px; font-size: 24px; background: #9ab7b7"> Filtros</a>
        </div>
