<?php
session_start();
$USERNAME = $_SESSION['account_nickname'];
?>
...
<head>
    ...
    <meta name="description" content="Fotoverso - Filtros Mis Galerias">
    <meta name="keywords" content="HTML, CSS, PHP, Fotos, Fotoverso, Imágenes, Red-Social, Comunicación">
    <title>Fotoverso - Filtros Mis Galerías</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta1/dist/css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="../css/FiltrosMisGalerias.css">
</head>
<body class="d-flex align-items-center justify-content-center" style="min-height: 100vh; background-image: url('../img/SubirBorrar_Foto_Background.png'); background-size: cover;">
    ...
    <div class="card shadow-lg p-4" style="max-width: 500px; background: rgba(255, 255, 255, 0.9); border-radius: 20px;">
        <div class="card-body">
            <h5 class="card-title text-center">Filtros de Busqueda para Mis Galerias</h5>
            <p class="card-subtitle mb-3 text-muted text-center">Ingrese los datos para configurar los filtros de busqueda</p>

            <form action="../php/Busqueda_Filtrada_MisGalerias.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="gallery" id="gallery" class="form-control" placeholder="Escriba el nombre de la galeria">
                </div>
