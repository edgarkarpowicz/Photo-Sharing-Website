...
<head>
    ...
    <title>Fotoverso - Mis Galerias</title>
...
<body>
    ...
    <div class="rectangle">
        ...
        <p class="info" style="text-shadow: 4px 3px 0px rgba(171, 183, 183, 1), 9px 8px 0px rgba(0,0,0,0.15); font-size: xxx-large"> MIS GALERIAS </p>
            <a href="../php/Sección_MisFotos.php" class="btn btn-outline-dark" style="margin-top: 5px; font-size: 24px; background: #9ab7b7">Fotos</a>
            <a href="../php/Crear_Galeria.php" class="btn btn-outline-dark" style="margin-top: 5px; font-size: 24px; background: #9ab7b7">Crear</a>
            <a href="../php/Filtros_MisGalerias.php" class="btn btn-outline-dark" style="margin-top: 5px; font-size: 24px; background: #9ab7b7">Filtros</a>
        </div>
      ...
      <div class="row">
        <div class="right-container">
            <div class="right-section"> 
                ...
                $object = mysqli_query($conn, "CALL LISTAR_GALERIAS_CON_ID('$ID')");
                //while($img_name = mysqli_fetch_array($result)) {
                    //echo $img_name['IMG_Perfil']; // Print a single column data
                    //echo print_r($img_name);       // Print the entire row data
                // } 
