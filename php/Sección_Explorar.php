...
<body>
    ...
    <header class="container-fluid d-flex justify-content-between align-items-center">
        ...
        <div class="rectangle">
            ...
            <p class="info" style="text-shadow: 4px 3px 0px rgba(171, 183, 183, 1), 9px 8px 0px rgba(0,0,0,0.15); font-size: xxx-large;"> EXPLORAR </p>
                <a href="../php/Ver_Galerias.php" class="btn btn-outline-dark" style="margin-top: 5px; font-size: 24px; background: #9ab7b7"> Galerias </a>
                <a href="../php/Filtros.php" class="btn btn-outline-dark"style="margin-top: 5px; font-size: 24px; background: #9ab7b7"> Filtros </a>
            </div>
                ...
                <div class="row">
                    <div class="right-container">
                        <div class="right-section"> 
                            ...
                            $object = mysqli_query($conn, "CALL LISTAR_FOTOS()");
                            //while($img_name = mysqli_fetch_array($result)) {
                                //echo $img_name['IMG_Perfil']; // Print a single column data
                                //echo print_r($img_name);       // Print the entire row data
                            // } 
                            ...
                            foreach ($TEMP_STORAGE_FOTOS as $fotos) {
                                ...
                                <div class='col' style='margin-bottom: 5px'>
                                    ...
                                    <form action='../php/Perfil_de_Otro.php' method='POST'>
                                        <input type='hidden' class='btn btn-outline-dark' style='background: #9ab7b7' name='USER_ID' value='{$profile['ID']}'>
