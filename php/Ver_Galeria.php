...
<head>
    ...
    <meta name="description" content="Fotoverso - Mis Galerias">
...
<body>
    ...
    <div class="rectangle">
        <div class="left-section">
            ...
            <p class="info" style="text-shadow: 4px 3px 0px rgba(171, 183, 183, 1), 9px 8px 0px rgba(0,0,0,0.15)"> <?php echo $_SESSION['account_nickname'] ?> </p>
            <p style="font-size: x-large; margin-bottom: 5px; margin-top: 10px; text-decoration: underline"> llamada </p>
            <?php 
                $servername = "localhost"; // or the server address provided by your web host
                $username = "picify_db_editor"; // your database username
                $password = "#Ek11Mn35Gr06#"; // your database password
                ...
                foreach($TEMP_STORAGE_ID_FOTOS as $fotos) {
                    ...
                    <div class='col'>
                        ...
                        <div class='imageInfo'>
                            ...
                            <u style='text-decoration: underline'>Categoria:</u> {$result['Nombre']} <br> 
                            <u style='text-decoration: underline'>Fecha:</u> {$TEMP_STORAGE_FOTOS['Fecha']} <br> 
                            <u style='text-decoration: underline'>Descripcion:</u> {$TEMP_STORAGE_FOTOS['Descripcion']} 
                        ...
                        <div style='text-align: center'>
                            <div>
                                <form action='../php/LLAMAR_ELIMINAR_GALERIA.php' method='POST' style='margin-top: 5px; margin-bottom: 5px'>
                                    <input type='hidden' name='gallery_id' value='{$GALLERY_ID}'>
                                    <input type='hidden' name='picture_id' value='{$TEMP_STORAGE_FOTOS['ID']}'>
                                    <input type='submit' class='btn btn-outline-dark' style='background: #9ab7b7' value='ELIMINAR DE ESTA GALERIA'>
                                </form>
                    ...
                    else 
                    {
                        ...
                        <div class='col'>
                            ...
                            <div class='imageInfo'>
                                ...
                                <u style='text-decoration: underline'>Categoria:</u> {$result['Nombre']} <br> 
                                <u style='text-decoration: underline'>Fecha:</u> {$TEMP_STORAGE_FOTOS['Fecha']} <br> 
                                <u style='text-decoration: underline'>Descripcion:</u> {$TEMP_STORAGE_FOTOS['Descripcion']} </p>
                            </div>
                            <div style='text-align: center'>
                                <div>
                                    <form action='../php/LLAMAR_ELIMINAR_GALERIA.php' method='POST' style='margin-top: 5px; margin-bottom: 5px'>
